...
<title>Orion Quotes | Manage Product</title>
...
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
      <form method="get" action="{{ action('PageController@product') }}">
          <div class="col-md-3">
            ...
            <label>Title</label>
                ...
                <input type="text" class="form-control" name="name" value="<?php echo @$_GET['name']; ?>"" placeholder="Title">
              </div>
...
<div class="col-md-12"> 
     {{ $pages->links() }} 
      ...
      <div class="clearfix">&nbsp;</div>
       <form id="team_form" method="post" action="remove-product"  onsubmit="return checkSelects('team_form');" >
        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
        <div class="table-toolbar">
         <div class="btn-group">
                 <a href="add-product" class="btn btn-outline btn-info btn-sm waves-effect waves-light"><i class="fa fa-plus"></i> Add New </a>
                </div>  
          <div class="btn-group">
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline collapsed" id="sample_1" role="grid">
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td>
                        ...
                        <img src="<?php echo url('/'); ?>/product/<?php echo $value->image ?>" alt="" style="max-width: 70px;display: block;margin-bottom: 10px;">
                        <?php } else{ ?>
                        <img src="<?php echo url('/'); ?>/product/default.png" alt="" style="max-width: 70px;display: block;margin-bottom: 10px;">
                        <?php
                        }?>
                      ...
                      <td><?php echo $value->L_total ?></td>
                      <td><?php if($value->status == 1){ echo "Acitve";}else{echo "Inactive";} ?></td>
                       <!-- <td><?php 
                      echo date('F d,Y h:i a', strtotime($value->created)); 
                       ?></td> -->
                       <td><?php if($value->show_homepage == 1){ echo "Yes";}else{echo "No";} ?></td>
                      <td><a href="edit-product/<?php echo $value->id?>" class="btn btn-outline btn-info btn-sm waves-effect waves-light" title="view"><i class="fa fa-edit"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
        </table>
