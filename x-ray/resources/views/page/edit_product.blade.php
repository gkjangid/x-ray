...
<title>X-ray India | Edit Product</title>
...
<!--<li class="nav-small-cap m-t-10">--- Main Menu</li>-->     <div id="page-wrapper">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="javascript:void(1);" style="color:#FFF;">Product</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="<?php echo url('/'); ?>/admin/manage-product" style="color:#FFF;">Product</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Edit Product</a>  
                </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
  <form id="page-form" enctype="multipart/form-data" role="form" class="" action="<?php echo url('/'); ?>/admin/update-product" novalidate method="post">
    ...
    <div class=" form-group ">
        ...
        <input type="text" name="title" id="title" value="<?php echo $product->title ?>" class="form-control required" placeholder="Title" autocomplete="off" required="" aria-required="true">
      </div>

      <div class=" form-group ">
        <label for="title" class="required" aria-required="true">Price</label>
        <input type="text" name="price" id="url" value="<?php echo $product->price ?>" class="form-control required" placeholder="product Url" autocomplete="off" required="" aria-required="true">
      </div>

          
      <div class=" form-group ">
        <label for="title" class="required" aria-required="true">Text</label>
        <textarea rows="4" name="description" id="msg" value="" class="form-control required ckeditor" placeholder="Description"><?php echo $product->description ?></textarea>

      </div>

      <div class="form-group "><label for="etabeebdXNlcnM_image" class="required" aria-required="true">product Image</label>
       ...
       <img src="<?php echo url('/'); ?>/public/uploads/<?php echo $product->image ?>" alt="" style="max-width: 100px;display: block;margin-bottom: 10px;">
       ...
       <div class=" form-group ">
        ...
        <select name="status" class="form-control required">
          <option value="1" <?php if($product->ptype==1) {echo 'SELECTED';} ?>>Featured Product</option>
          <option value="2" <?php if($product->ptype==2) {echo 'SELECTED';} ?>>Popular Product</option>
          <option value="3" <?php if($product->ptype==3) {echo 'SELECTED';} ?>>Best Product</option>
          <option value="4" <?php if($product->ptype==4) {echo 'SELECTED';} ?>>Recent Product</option>
        </select>
      </div>
