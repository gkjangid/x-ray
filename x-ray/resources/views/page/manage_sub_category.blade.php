...
<div class="col-md-12"> 
 ...
 <?php } ?></td>
                      ...
                      <td><a href="<?php echo url('/'); ?>/admin/edit-category/<?php echo $value->id?>" class="btn btn-outline btn-info btn-sm waves-effect waves-light" title="view"><i class="fa fa-edit"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
        </table>
