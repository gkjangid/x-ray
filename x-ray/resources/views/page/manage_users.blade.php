...
<title>X-ray india | Manage Users</title>
...
<div style="clear:both;"></div>
  ...
  <div class="white-box">
     ...
     if (isset($_GET['type'])) {
       ?>
       <form method="POST" action="{{ action('PageController@delete_users') }}">
            ...
            <label>Select State</label> 
              <select class="form-control"  name="state" id="state">
                <option <?php if(empty(@$_GET['status'])) echo "Selected"; ?>>Select State</option>
                <?php
            ...
            <label>Select City</label> 
              <select class="form-control"  name="city" id="city">
                <option <?php if(empty(@$_GET['status'])) echo "Selected"; ?>>Select City</option>
            ...
            <div class="col-md-2" style=" margin-top: 25px;">
              <button type="button" onclick="this.form.submit()" id="button-filter" class="btn btn-primary"><i class="fa fa-filter"></i> Delete Now</button>
              </div>
        </form>
       <?php
     }
       ...
       <form id="team_form" method="post" action="remove-users"  onsubmit="return checkSelects('team_form');" >
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline collapsed" id="sample_1" role="grid">
                    ...
                    <?php } ?></td>
                      ...
                      <td><a href="javascript:" class="btn btn-outline btn-info btn-sm waves-effect waves-light" title="view"><i class="fa fa-edit"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
        </table>
...
var id=$(this).attr('id');
   $.ajax({
              ...
              data: 'status='+vl+'&id='+id+'&table=vendors',            
