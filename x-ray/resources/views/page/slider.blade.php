...
<title>Orion Quotes | Manage Slider</title>
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="javascript:void(1);" style="color:#FFF;">Slider</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Slider</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
            </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
      <form method="get" action="{{ action('PageController@slider') }}">
          <div class="col-md-3">
...
<div class="col-md-12"> 
     {{ $pages->links() }} 
      ...
      <div class="clearfix">&nbsp;</div>
       <form id="team_form" method="post" action="remove-slider"  onsubmit="return checkSelects('team_form');" >
        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
        <div class="table-toolbar">
         <div class="btn-group">
                 <a href="add-slider" class="btn btn-outline btn-info btn-sm waves-effect waves-light"><i class="fa fa-plus"></i> Add New </a>
                </div>  
          <div class="btn-group">
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline collapsed" id="sample_1" role="grid">
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td>
                        ...
                        <img src="<?php echo url('/'); ?>/slider/<?php echo $value->image ?>" alt="" style="max-width: 70px;display: block;margin-bottom: 10px;">
                        <?php } else{ ?>
                        <img src="<?php echo url('/'); ?>/slider/default.png" alt="" style="max-width: 70px;display: block;margin-bottom: 10px;">
                        <?php
                        } echo $value->short_dec; ?>
                      </td>
                      <td><?php if($value->status == 1){ echo "Acitve";}else{echo "Inactive";} ?></td>
                       <td><?php 
                      echo date('F d,Y h:i a', strtotime($value->created)); 
                       ?></td>
                      <td><a href="edit-slider/<?php echo $value->id?>" class="btn btn-outline btn-info btn-sm waves-effect waves-light" title="view"><i class="fa fa-edit"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
        </table>
