...
<title>Orion Quotes | Add Slider</title>
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="<?php echo url('/'); ?>/orion-admin/manage-slider" style="color:#FFF;">Slider</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Add Slider</a>  
                </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
  <form id="page-form" enctype="multipart/form-data" role="form" class="" action="<?php echo url('/'); ?>/orion-admin/save-slider" novalidate method="post">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
      ...
      <div class=" form-group ">
        ...
        <input type="text" name="short_dec" id="short_dec" value="" class="form-control required" placeholder="Title" autocomplete="off" required="" aria-required="true">
      </div>
