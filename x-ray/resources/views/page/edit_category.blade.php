...
<title>X-ray India | Edit Category</title>
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>//orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="javascript:void(1);" style="color:#FFF;">Category</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="<?php echo url('/'); ?>/admin/manage-category" style="color:#FFF;">Category</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Edit Category</a>  
                </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
  <form id="page-form" enctype="multipart/form-data" role="form" class="" action="<?php echo url('/'); ?>/admin/update-category" novalidate method="post">
     ...
     <div class=" form-group ">
        <label for="title" class="required" aria-required="true">Select Category(if you add sub category)</label>
              ...
              foreach ($category as $key => $values) {
                ?>
              <option value="<?php echo $values->id ?>" <?php if($values->id==$value->pid) { echo 'selected';}?>><?php echo $values->category ?></option>
      ...
      <div class=" form-group ">
        <label for="category_title" class="required" aria-required="true">Category</label>
        <input type="text" name="title" id="category_title" value="<?php echo $value->category ?>" class="form-control required" placeholder="Category" autocomplete="off" required="" aria-required="true">
      </div>
      <div class=" form-group ">
