...
<title>X-ray India | Manage Categories</title>
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="javascript:void(1);" style="color:#FFF;">Category</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Category</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
            </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
      <form method="get" action="{{ action('PageController@manage_category') }}">
...
<div class="col-md-12"> 
      ...
      <div class="clearfix">&nbsp;</div>
       <form id="team_form" method="post" action="remove-category"  onsubmit="return checkSelects('team_form');" >
        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
        <div class="table-toolbar">
         <div class="btn-group">
                 <a href="add-category" class="btn btn-outline btn-info btn-sm waves-effect waves-light"><i class="fa fa-plus"></i> Add New </a>
                </div>  
          <div class="btn-group">
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline collapsed" id="sample_1" role="grid">
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td><a href="<?php echo url('/'); ?>/admin/manage-sub-category/<?php echo $value->id; ?>" class="btn btn-sm">View</a></td>
                               <td><?php if($value->status == 1){ ?><label class="switch">
  <input type="checkbox" class="chk ids<?php echo $value->id; ?>" value="0" id="<?php echo $value->id; ?>" checked>
  <span class="slider round"></span>
</label>
 <?php } else{ ?><label class="switch">
  <input type="checkbox" class="chk ids<?php echo $value->id; ?>" value="1" id="<?php echo $value->id; ?>" >
  <span class="slider round"></span>
</label>
 <?php } ?></td>
                      
                      <td><a href="edit-category/<?php echo $value->id?>" class="btn btn-outline btn-info btn-sm waves-effect waves-light" title="view"><i class="fa fa-edit"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
        </table>
...
var id=$(this).attr('id');
   $.ajax({
              url: "http://destinysolution.in/x-ray/admin/update_status_category",
              data: 'status='+vl+'&id='+id+'&table=category',            
