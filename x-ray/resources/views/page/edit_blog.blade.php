    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="javascript:void(1);" style="color:#FFF;">Blogs</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="<?php echo url('/'); ?>/orion-admin/manage-blog" style="color:#FFF;">Blogs</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Edit Blog</a>  
                </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
  <form id="page-form" enctype="multipart/form-data" role="form" class="" action="<?php echo url('/'); ?>/admin/update-blog" novalidate method="post">
    ...
    <input type="hidden" name="old_image" value="{{ $pages->image }}">
      <div class=" form-group ">
        ...
        <input type="text" name="title" id="category_title" value="<?php echo $pages->title ?>" class="form-control required" placeholder="Category" autocomplete="off" required="" aria-required="true">
      </div>
      <div class="row">
        <div class="form-group">
          <div class="col-md-12">
      ...
      <img src="<?php echo url('/'); ?>/blogs/<?php echo $pages->image ?>" alt="" style="max-width: 100px;display: block;margin-bottom: 10px;">
      <div class=" form-group ">
