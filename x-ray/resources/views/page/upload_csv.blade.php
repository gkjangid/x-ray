...
<title>X-ray India | Add-User</title>
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="<?php echo url('/'); ?>/admin/manage-users" style="color:#FFF;">Users</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Add User's</a>  
                </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
  <form id="page-form" enctype="multipart/form-data" role="form" class="" action="<?php echo url('/'); ?>/admin/upload-CSV" novalidate method="post">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    
      
      <div class="clearfix">&nbsp;</div>
      <div class="form-group ">
        <label for="etabeebdXNlcnM_image" class="required" aria-required="true">CSV File</label>
        <input type="hidden" name="MAX_FILE_SIZE" value="268435456" id="MAX_FILE_SIZE">
        <input type="file" name="image" id="" requrid class="default input-file"  aria-required="true">
      </div>
   <!--    <div class=" form-group ">
