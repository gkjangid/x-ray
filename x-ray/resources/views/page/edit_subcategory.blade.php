...
<title>Orion Quotes | Edit Sub-Category</title>
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/orion-admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="javascript:void(1);" style="color:#FFF;">Category</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="<?php echo url('/'); ?>/orion-admin/manage-subcategory" style="color:#FFF;">Sub-Category</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Edit Sub-Category</a>  
                </ul>
</div>
<div style="clear:both;"></div>
      <div class="row">
  <div class="white-box">
  <form id="page-form" enctype="multipart/form-data" role="form" class="" action="<?php echo url('/'); ?>/orion-admin/update-subcategory" novalidate method="post">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
     <input type="hidden" name="id" value="<?php echo $pages->id ?>">
      <div class=" form-group ">
        ...
        <select name="category_id" class="form-control required">
          <?php foreach ($category as $key => $value) { ?>
             <option value="<?php echo $value->id ?>" <?php if($value->id == $pages->category_id){ echo "selected"; } ?>><?php echo $value->title ?></option>
          <?php
          }
          ?>
        </select>
      ...
      <div class=" form-group ">
        ...
        <input type="text" name="title" id="title" value="<?php echo $pages->title ?>" class="form-control required" placeholder="Title" autocomplete="off" required="" aria-required="true">
      </div>
      <div class=" form-group ">
