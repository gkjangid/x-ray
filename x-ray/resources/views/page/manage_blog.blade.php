...
<title>X-ray India | Manage Blogs</title>
...
<!--<li class="nav-small-cap m-t-10">--- Main Menu</li>-->     <div id="page-wrapper">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <a href="<?php echo url('/'); ?>/admin" style="color:#FFF;"><i class="fa fa-dashboard"></i> Dashboard</a>  
                    ...
                    <a href="javascript:void(1);" style="color:#FFF;">Blogs</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
                    <a href="" style="color:#FFF;">Blogs</a>  
                             <i class="fa fa-chevron-right" style="vertical-align:middle; color:#FFF;"></i>
            </ul>
</div>
...
<div class="col-md-12"> 
      ...
      <div class="clearfix">&nbsp;</div>
       <form id="team_form" method="post" action="remove-blog"  onsubmit="return checkSelects('team_form');" >
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline collapsed" id="sample_1" role="grid">
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td>
                        <img src="<?php echo url('/'); ?>/blogs/<?php echo $value->image ?>" alt="" style="max-width: 100px;display: block;margin-bottom: 10px;">
                    ...
                    <?php } ?></td>
                      ...
                      echo date('F d,Y h:i a', strtotime($value->created)); 
                       ?></td>
                      <td><a href="edit-blog/<?php echo $value->id?>" class="btn btn-outline btn-info btn-sm waves-effect waves-light" title="view"><i class="fa fa-edit"></i></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
        </table>
...
var id=$(this).attr('id');
   $.ajax({
              ...
              data: 'status='+vl+'&id='+id+'&table=blogs',            
