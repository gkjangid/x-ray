...
<meta name="keywords" content="Durrows" >
<meta name="description" content="Durrows,directid" >
<title>Orion Quotes | Forgot password</title>
...
<section id="wrapper" class="login-register">
  <div class="login-box">
    ...
    @endif
    @if (session('error'))
        <div class="alert alert-error" style="background: #f6616166;color: #e02626;">
            {{ session('error') }}
        </div>
    @endif
    <div class="white-box">
        <!-- <form class="form-horizontal" role="form" method="POST" action="{{ url('/password/email') }}"> -->
        <form class="form-horizontal" role="form" class="" action="<?php echo url('/'); ?>/save-password" novalidate method="post">
        {!! csrf_field() !!}
        <!-- <a class="logo"><img src="<?php echo url('/'); ?>/assets/images/headerLogo.png" alt="" /></a> -->
        <h3 class="box-title m-b-20">FORGOT PASSWORD</h3>
        <div class="form-group ">
        <div class="col-xs-12">
        <input type="email" class="form-control forgettext" name="email" value="{{ old('email') }}" placeholder="Email">
        @if ($errors->has('email'))
