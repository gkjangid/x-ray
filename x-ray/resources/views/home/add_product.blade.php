                ...
                <div class="tz-2-com tz-2-main">
                    ...
                    <div class="db-list-com tz-db-table">
                        ...
                        <div class="hom-cre-acc-left hom-cre-acc-right">
                            <div class="">
                                <form class="" method="post" action="<?php echo url('/'); ?>/save_product" enctype="multipart/form-data">
                                                                        <div class="row">
                                        <input type="hidden" class="validate" value="34" name="user_id">
                                        <div class="input-field col s12">
                                            <input id="first_name" type="text" class="validate" value="" placeholder="Enter Product Title" name="title">
                                        </div>
                                        
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="list_name" type="text" class="validate" value="" name="price" placeholder="Price">
                                        </div>
                                    </div>

                                      <div class="row">
                                        <div class="input-field col s12">
                                            <input id="list_name" type="file" class="validate" value="" name="file" placeholder="Price">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 v2-mar-top-40"> <i class="waves-effect waves-light btn-large full-btn waves-input-wrapper" style=""><input type="submit" class="waves-button-input" name="update" value="Add Product"></i></div>
                                    </div>
                                </form>
                            </div>
                        </div>
