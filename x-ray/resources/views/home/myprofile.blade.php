                ...
                <div class="tz-2-com tz-2-main">
                    ...
                    <div class="db-list-com tz-db-table">
                        ...
                        <table class="responsive-table bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><?php echo $profile->Institute_Name ?></td>
                                </tr>
                                <tr>
                                    <td>Institute Address</td>
                                    <td>:</td>
                                    <td> <?php echo $profile->Institute_Address ?></td>
                                </tr>
                                <tr>
                                    <td>Profile Image</td>
                                    <td>:</td>
                                    <td><img src="<?php echo url('/'); ?>/public/users/<?php echo $profile->image ?>" alt=""></td>
                                </tr>
                                <!-- <tr>
                                    <td>Status</td>
                                    <td>:</td>
                        ...
                        <div class="db-mak-pay-bot">
                            <a href="<?php echo url('/'); ?>/update-profile" class="waves-effect waves-light btn-large">Edit my profile</a> </div>
                    </div>
                </div>
            </div>
			<!--RIGHT SECTION-->
